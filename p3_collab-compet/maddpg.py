...
class MADDPG:
    def __init__(self, num_agents, layer_params, discount_factor=0.95, tau=0.02):
        ...
        self.maddpg_agent = [DDPGAgent(layer_params['in_actor'], layer_params['hidden_in_actor'], layer_params['hidden_out_actor'],                 layer_params['out_actor'],layer_params['in_critic'], layer_params['hidden_in_critic'], layer_params['hidden_out_critic'])                   for i in range(num_agents)]
